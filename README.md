...
This implementation adds 5 different types of trials focusing on the two different game modes and the materials found from defeating enemy captains
- **Story Mode** adds objectives for completing missions in the Story Mode
- **Story Mode with Characters** adds objects identical to those from the above category, but with additional restrictions on playable characters
